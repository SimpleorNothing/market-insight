...
6. summary: 3줄 이내 한국어
   - 정량 수치 1개 이상
   - 모호 표현 금지
   - 실적(어닝)·재무 기사: 매출, 이익, 전년 대비 증감률을 원문 수치 그대로 포함
...
8. summaryPoints: 기사 원문 내용을 2~3개의 짧은 포인트로 정리한 배열
   ...
   - ★실적(어닝) 기사 필수 3요소★: ① 매출 ② 이익(영업이익·순이익) ③ 전년 대비 증감률
     세 요소를 포인트에 반드시 포함 (예: "2분기 매출 23조8297억원, 전년比 14.9%↑" /
     "영업이익 1조5788억원, 전년比 146.9%↑" / "상반기 영업익 3조2525억, 작년 연간 초과")

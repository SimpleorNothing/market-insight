...
- **경쟁사 13사** + `competitorBrands` 하위 브랜드 → 모기업 매핑 (예: KUKA→Midea, GE Appliances→Haier, KitchenAid→월풀)
...
- **원문 충실 원칙**: 포인트는 원문의 구체 수치·고유명사를 그대로 옮김 (추상 표현으로 뭉개지 않음). 실적(어닝) 기사는 ①매출 ②이익 ③전년 대비 증감률 3요소 필수 포함.

...
| PR | 일자 | 내용 |
|---|---|---|
| #138 | 09-23 | fix(sensing): 한글 원문 우선 선택을 전 경쟁사 브랜드로 확장 |
| #137 | 09-23 | fix(sensing): LG전자 기사 대표 링크로 한글 원문 우선 선택 |
| #136 | 09-20 | feat(gate): /data/* 기계 소비용 토큰(MI_DATA_TOKEN) 우회 경로 추가 |
| #135 | 09-20 | fix(gate): 비공개 저장소에서도 mi.samsungda.net 서빙되도록 gate Worker 수정 |
| #134 | 09-18 | 경쟁사별 보기: 경쟁사 그룹 우선 노출 → 가구·통상관세 순 |
